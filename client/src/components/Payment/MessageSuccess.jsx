    ...
    return(
        <div className={s.globalCont}>
            ...
            <div id={s.successBox}>
                ...
                <div className={s.message}><h1 className={s.alertM}>SUCCESS!</h1><h1 className={s.alertM}>YOU ARE PREMIUM NOW!</h1></div>
                <button className={s.buttonBoxM} onClick={handleClick}><h1 className={s.green}>CONTINUE</h1></button>
            </div>
            {/* <div id="error-box">
