...
export default function DashCountryTable({array, select, callbk}) {
    ...
    <TableContainer component={Paper} sx={{ width: 1000}}>
      ...
      <TableHead className={s.head}> 
          <TableRow className={s.head}>
            <StyledTableCell className={s.head}>Id</StyledTableCell>
            <StyledTableCell align="left">{select}</StyledTableCell>
            <StyledTableCell align="left">Acction</StyledTableCell>
          </TableRow>
        </TableHead>
        <TableBody>
          {(rowsPerPage > 0
