        ...
        <div className={s.container}>
            <div className={s.containerSlide} ref={slideshow}>
                <div className={s.slide}>
                    <a href="#">
                        <img className={s.img} src={require("./img/carrusel1.png")} alt="" />
                    </a>
                ...
                <div className={s.slide}>
                    <a href="#">
                        <img className={s.img} src={require("./img/carrusel2.png")} alt="" />
                    </a>
                    <div className={s.textSlide}>
                        Buy now and get a discount of 15%
                    </div>
                ...
                <div className={s.slide}>
                    <a href="#">
                        <img className={s.img} src={require("./img/carrusel3.png")} alt="" />
                    </a>
                    <div className={s.textSlide}>
                        Buy now and get a discount of 15%
                    </div>
